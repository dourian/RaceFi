...
export const baseChallenges = [
  ...
  },
  {
    ...
    description: "Early bird special! A quick 3km sprint through the city center. Perfect for starting your day with energy.",
    distanceKm: 3,
    windowDays: 5,
    stake: 3,
    elevation: 45,
    ...
    polyline: "u`~gGfkwuOwBcC_AyA{@wAaAqBs@_BYo@k@uA[s@m@wAo@yAg@iA]y@Wm@Oe@Qg@Oe@Mk@Gq@Eq@Cu@Aw@?w@Bw@Du@Fs@Hq@Jm@Nk@Ri@Vi@Zg@^e@`@c@b@a@d@_@f@]h@[j@Yl@Wn@Up@Sr@Qt@Ov@Mt@Kv@Ix@Gz@Ez@C|@A|@",
    routeColor: "#f59e0b", // Orange for morning
  },
  {
    id: "sunset-7k",
    name: "Sunset 7K Loop",
    description: "Run as the sun sets over the hills. A beautiful 7km loop with rolling terrain and stunning views.",
    distanceKm: 7,
    windowDays: 10,
    stake: 8,
    elevation: 120,
  ...
  },
  {
    ...
    polyline: "_c}aGzp~rTsAe@wAg@uAi@sAk@qAm@oAo@mAq@kAs@iAu@gAw@eAy@cA{@aA}@_A_@]a@[c@Ye@Wg@Ui@Si@Qk@Ok@Mm@Km@Io@Go@Eq@Cq@Aq@?s@?s@Bs@Ds@Fq@Hq@Jq@Lp@Nn@Pn@Rn@Tl@Vl@Xj@Zj@\\j@^h@`@h@b@f@d@f@f@d@h@d@j@b@j@`@l@^l@\\n@Zn@Xp@Vp@Tr@Rs@Ps@Nu@Lu@Jw@Hw@Fy@Dy@B{@?{@A{@C{@E{@G{@I{@K{@M{@O{@Q{@S{@U{@W{@Y{@[{@]{@_{@a{@c{@e{@g{@i{@k{@m{@o{@q{@s{@u{@w{@y{@{{@}{@_{A_{Ac{Ae{Ag{Ai{Ak{Am{Ao{Aq{As{Au{Aw{Ay{A{{A}{A_{C_{Ce{Cg{Ci{Ck{Cm{Co{Cq{Cs{Cu{Cw{Cy{C{{C}{C",
    routeColor: "#059669", // Mountain green
  },
  {
    id: "beach-4k",
    name: "Beach Run 4K",
    description: "Feel the sand between your toes! A refreshing 4km beach run with ocean breeze and minimal elevation.",
    distanceKm: 4,
    windowDays: 6,
    stake: 4,
    elevation: 15,
    ...
    polyline: "o`}pD~b{qOoAaBoAmB{@wAy@uAw@sAu@qAs@oAq@mAo@kAm@iAk@gAi@eAg@cAe@aAc@_Aa@]A_@_A]A_A[A_AYA_AWYA_AUWA_ASYA_AQYA_AOYA_AMYA_AKYA_AIYA_AGYA_AEYA_ACYA_AAYA_A?YA_AB{@D{@F{@H{@J{@L{@N{@P{@R{@T{@V{@X{@Z{@\\{@^{@`@{@b@{@d@{@f@{@h@{@j@{@l@{@n@{@p@{@r@{@t@{@v@{@x@{@z@{@|@{@~@{@`A{@bA{@dA{@fA{@hA{@jA{@lA{@nA{@pA{@rA{@tA{@vA{@xA{@zA{@|A{@~A{@`B{@bB{@dB{@fB{@hB{@jB{@lB{@nB{@pB{@rB{@tB{@vB{@xB{@zB{@|B{@~B{@`C{@bC{@",
    routeColor: "#06b6d4", // Beach cyan
  },
  {
    id: "downtown-8k",
    name: "Downtown 8K Circuit",
    description: "Urban running at its finest! Navigate through the bustling downtown core on this 8km circuit with moderate hills.",
    distanceKm: 8,
    windowDays: 8,
    stake: 12,
    elevation: 95,
  ...
  },
  {
    ...
    polyline: "kqp}G`uykV_CqA_CsAaCsAaCuA_CuA_CwA}BwA}ByA{ByAyB{AwB{AwB}AuB}AuB_BsB_BsBaBqBaBqBcBoB",
  ...
  // Expired Challenges
  {
    ...
    description: "The ultimate winter challenge! A full marathon through snowy trails with breathtaking winter scenery.",
    distanceKm: 42.2,
    windowDays: 21,
    stake: 50,
    elevation: 500,
    ...
    polyline: "_c}aGzp~rTsAe@wAg@uAi@sAk@qAm@oAo@mAq@kAs@iAu@gAw@eAy@cA{@aA}@_A",
    routeColor: "#6366f1", // Indigo for winter
  },
  {
    id: "spring-5k",
    name: "Spring Blossom 5K",
    description: "Celebrate spring with a beautiful 5km run through blooming cherry blossom trees and parks.",
    distanceKm: 5,
    windowDays: 7,
    stake: 8,
    elevation: 50,
  ...
  },
  {
    id: "night-owl-10k",
    name: "Night Owl 10K",
    description: "Run under the stars! A nighttime 10km challenge through illuminated city streets and parks.",
    distanceKm: 10,
    windowDays: 10,
    stake: 15,
    elevation: 80,
