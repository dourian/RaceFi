...
export default function BrowseScreen() {
  ...
  const isExpired = (challenge: any) => {
    try {
      ...
      console.warn(
        "Invalid challenge endDate in isExpired:",
        challenge.endDate,
      );
      return false;
    }
  ...
  const getExpiryInfo = (challenge: any, challengeStatus: any) => {
    ...
    if (challengeStatus.status === "winner") {
      ...
      return {
        text: "Winnings added to balance",
        color: "#22c55e",
        urgent: false,
      };
                          ...
                          <View style={styles.expiryRow}>
                            ...
                            <Text
                              style={[
                                styles.expiryText,
                                {
                                  color: getExpiryInfo(item, challengeStatus)
                                    .color,
                                },
                                getExpiryInfo(item, challengeStatus).urgent &&
                                  styles.expiryTextUrgent,
                              ]}
                            >
